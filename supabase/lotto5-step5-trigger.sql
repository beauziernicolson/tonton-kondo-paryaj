-- Lotto5 trigger automation migration
-- Met à jour la fonction de publication des résultats pour inclure Lotto5.
...
BEGIN
  ...
  ELSIF NEW.game_type = 'lotto5' THEN
    PERFORM public.check_lotto5_results(NEW.id);
    PERFORM public.pay_lotto5_winnings(NEW.id);
  END IF;
